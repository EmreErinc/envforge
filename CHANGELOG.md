...
### Changed
- Core crate (`env-forge-tui`) version set to **1.0.3**.
- Editor plugins versioned at **0.3.0** (VS Code, IntelliJ, Zed).
- Site and docs stamps synced to CLI 1.0.3 / plugins 0.3.0.

## [1.0.2] - 2026-09-01

### Changed
- Core crate (`env-forge-tui`) version set to **1.0.2**.
