...
/// Build document symbols for config-format files (`.properties`, `.env`-cascade,
/// YAML). Works with the format-agnostic [`ConfigEntry`] model (F6 fix).
pub fn config_document_symbols(
    entries: &[ConfigEntry],
