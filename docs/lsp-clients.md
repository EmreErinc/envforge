...
|---|---|---|
| VS Code | ✓ `envforge-env-manager` 0.3.0 | Install via Marketplace or the bundled `.vsix` |
| IntelliJ Platform (Idea, GoLand, PyCharm, RustRover, …) | ✓ `envforge-intellij` 0.3.0 | Settings → Plugins → Install Plugin from Disk |
