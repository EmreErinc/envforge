...
| Category | Highlights |
|----------|-----------|
| **AI Safety** | 30+ tools: canary (v1+v2 forensic), approval flow, guard, leases (incl. JIT/PID-bound), killswitch, proxy, fence, MCP harden, deps, exposure, hardening, ci-trust |
