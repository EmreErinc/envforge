...
- **Secret Fence** — `.env` files protected from AI coding agents (Cursor, Copilot, Claude) via auto-generated ignore rules. Run `envforge fence` to activate. Status indicator in the status bar.
