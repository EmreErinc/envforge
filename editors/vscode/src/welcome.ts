...
<body>
    <div class="container">
        <div>
            ...
            <p class="description">
                Environment manager with profiles (dev / staging / prod), .env.schema validation, and a TUI in the terminal. This extension adds a sidebar and LSP; fence/guard need the CLI.
            </p>
        </div>
        ...
        <div class="card">
            ...
            <ul style="margin: 8px 0 8px 18px; padding: 0; font-size: 13px; color: var(--text-secondary); line-height: 1.6;">
                ...
                <li><b>Multi-Profile Switching:</b> Switch between <code style="color: var(--accent-light);">dev</code>, <code style="color: var(--accent-light);">staging</code>, and <code style="color: var(--accent-light);">prod</code> profiles.</li>
